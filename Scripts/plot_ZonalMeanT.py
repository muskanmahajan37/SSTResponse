"""
Script plots the zonal mean zonal temperature response across all latitudes.
...
directoryfigure = '/home/zlabe/Desktop/SSTVARI/ZonalMeanT/'
...
### Read in data
anomy,climoy,pvaly,lat,lon,lev = readDataPeriods('TEMP',['SST_Fu','SST_Cu'],'Annual')
anomwi,climowi,pvalwi,lat,lon,lev = readDataPeriods('TEMP',['SST_Fu','SST_Cu'],'JFM')
anomsu,climosu,pvalsu,lat,lon,lev = readDataPeriods('TEMP',['SST_Fu','SST_Cu'],'JJA')
...
for i in range(len(data)):
    ...
    cs1 = plt.contour(lat,lev,climo,np.arange(-80,81,10),
...
plt.savefig(directoryfigure + 'T_zonalmean.png',dpi=300)